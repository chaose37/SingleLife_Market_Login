...
<!-- 							</div> -->
	...
	<form id="jobForm">
		...
		<input type='hidden' name='perPageNum' value=${pagemaker.cri.perPageNum}>
					...
					<table border=1px>
					<tr>
						<td id="td1"><a href="${pageContext.request.contextPath}/board/readPage?bno=${boardVO.bno}">
							<img src="${pageContext.request.contextPath}/displayFile?fileName=${boardVO.files[0]}" width="130", height="90" onerror='this.src="/displayFile?fileName=/logo2.png"'/></a></td>
					<tr>
						<td><a href="${pageContext.request.contextPath}/board/readPage?bno=${boardVO.bno}">${boardVO.title}[${boardVO.viewcnt}]</a></td>
					</tr>				
					<tr>
						<td>No. ${boardVO.bno}  |  <fmt:formatDate value="${boardVO.regdate}" pattern="yy:MM:dd" /></td>						
					</tr>
					<tr>
...
<%-- 						<a href='/board/readPage${pageMaker.makeSearch(pageMaker.cri.page)}&bno=${boardVO.bno}'>${boardVO.title}</a></span></td> --%>
...
<%-- 						</c:forEach> --%>
					...
					<div class="pull-right hidden-xs">
						<button type="button" class="btn btn-lg btn-primary"
							onclick="location.href='${pageContext.request.contextPath}/board/register'">글쓰기</button>
					</div>
				</div>
			</div>
		</div>
