					...
					<ul class="nav navbar-nav">
						...
						<c:choose>
							...
							<c:when test="${empty login.email}">
								<li><a id="loginBtn" href="#" data-target="#loginModal" data-toggle="modal">로그인</a></li>
							</c:when>
							<c:otherwise>
								<li><a href="http://localhost:8000/user/logout">로그아웃</a></li>
							</c:otherwise>
						</c:choose>
						...
						<li class="dropdown user user-menu"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> <img
								...
								class="user-image" alt="User Image" /> <span class="hidden-xs">롤백은없습니다</span>
						</a>
							<ul class="dropdown-menu">
								<!-- User image -->
								<li class="user-header"><img
									...
									class="img-circle" alt="User Image" />
									<p>
										롤백은없습니다 - Web Developer <small>-가입일이 들어가네요-</small>
									</p></li>
								<!-- Menu Body -->
								<li class="user-body">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="treeview"><a href="#"> <i
							class="fa fa-dashboard"></i> <span>게시판</span> <i
							class="fa fa-angle-left pull-right"></i>
					</a>
						<ul class="treeview-menu">
							<li><a
								href="${pageContext.request.contextPath}/board/listPage"><i
									class="fa fa-circle-o"></i>게시판 v1</a></li>
							<%--                 <li><a href="${pageContext.request.contextPath}/board/listAll"><i class="fa fa-circle-o"></i>게시판 v1</a></li> --%>
							<li><a href="${pageContext.request.contextPath}/board/list"><i
									class="fa fa-circle-o"></i>게시판 v2</a></li>
						</ul></li>
		...
		<div class="modal-dialog login animated">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<div class="forgot login-footer"></div>
